...
from code.transformer.ops import LayerNorm
from code.prior.autoregressive import ConditionalAutoregressive2D
from code.prior.conditioners import Conditioner, LabelConditioner
from code.data.labels import EmptyLabeller, Labeller

from code.utils.torch_utils import assert_shape
    ...
    def __init__(self, z_shapes, l_bins, encoder, decoder, level,
        ...
        if single_enc_dec:
            ...
            if self.n_tokens != 0 and self.use_tokens:
                from code.transformer.ops import Conv1D
